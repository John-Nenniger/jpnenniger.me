        ...
        <div className="contents">
            <div className="writing">
                ...
                <article className="writing__container">
                    ...
                    <p>
                        Here are some goals I had before starting the project:
                    </p>

                        <ul>Get something simple and functional up relatively quickly, and expand its functionality later.</ul>

                    <p>
                        This is the most important thing I tell Codecore students when it comes to their final projects, so I might as well follow the advice myself.  
                        Decide on the core functionality of your app, make that deadline modest, and worry about the peripheral features later.  
                    ...
                    <p>
                        Understand thoroughly all the technologies I’m using, avoid libraries for small tasks.
                    </p>
                    ...
                    <ul className="writing__bullet">
                        <FontAwesomeIcon className="writing__bullet_icon" icon="dot-circle"/>Complete the project, put it out into the world,
                    </ul>
                    <ul className="writing__bullet">
                        <FontAwesomeIcon className="writing__bullet_icon" icon="dot-circle"/>try not to stress.
                    </ul>
                    ...
                    <ul className="writing__bullet">
                        <FontAwesomeIcon className="writing__bullet_icon" icon="dot-circle"/>relatively weak web design skill compared to general programming ability,
                    </ul>
                    <ul className="writing__bullet">
                        <FontAwesomeIcon className="writing__bullet_icon" icon="dot-circle"/>reluctance to put something imperfect behind my name,
                    </ul>
                    <ul className="writing__bullet">
